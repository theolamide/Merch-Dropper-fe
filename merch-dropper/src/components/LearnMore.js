    ...
    <PageWrapper>
      <TopImage>
        <TextWrapper>
          ...
          <TopParaText>
            {" "}
            It's the fastest way to set up a hassle free merch shop. Platform to
            upload designs and create products that plug into scalablepress.com
            to create a drop-shipping online shop.{" "}
          </TopParaText>
        </TextWrapper>
      </TopImage>
      ...
      <ObjectiveWrapper>
        <ObjectiveDiv>
          ...
          <ObjectiveText>
            ...
            <li>
              Information overload when reseraching where to source merchandise
            </li>
          ...
          <ObjectiveText>
            <li>
              You don't carry any inventory. That's on us and our partners.
            </li>
            <li>
              One stop shop on all things you need for creating merch for your
              store.
            </li>
        ...
        <ObjectiveDiv style={{ height: "18rem" }}>
          ...
          <ObjectiveText>
            Enable anyone to set up a custom swag shop effortlessly on their own
            domain. To save early entrepreneurs the headache, time and money
            sinkhole that early days swag can be. And to quench the desire to
            have swag of every early company starter without actually requiring
            more than a small monthly expense.
          </ObjectiveText>
        </ObjectiveDiv>
      </ObjectiveWrapper>

      <TeamHeaderImage>
        <TopHeaderText style={{ margin: "auto", color: "#FF8A00" }}>
          MEET OUR TEAM
        </TopHeaderText>
      </TeamHeaderImage>
      ...
      <CardsWrapper>
        <IndividualCard>
          <PersonImage
            src={
              "https://media-exp1.licdn.com/dms/image/C5603AQEMam4iJFvQfw/profile-displayphoto-shrink_200_200/0?e=1588204800&v=beta&t=3Eib0IgBj9fK5A20aLJw06XGNTFex6zJD36e-mcMhWM"
            }
          ></PersonImage>
          <TextBodyWrapper>
            ...
            <SocialWrapper>
              <SocialLink
                href={"https://www.linkedin.com/in/buzrocks/"}
                target="_blank"
              >
                <img
                  style={{ width: "2rem" }}
                  src={
                    "https://camo.githubusercontent.com/29d14f310b62515d0c7bc80067d02e5a801bc2b5/68747470733a2f2f7374617469632e6c6963646e2e636f6d2f73632f682f616c326f397a727672753761716a3865317832727a73726361"
                  }
                  alt="LinkedIn Icon"
                />
              </SocialLink>
